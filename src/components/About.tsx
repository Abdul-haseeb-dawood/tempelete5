    ...
    <div>
      ...
      <header className="bg-gray-100">
        ...
        <nav className="sm:flex-none lg:flex lg:justify-between lg:items-center md:flex md:justify-between md:items-center px-4 lgpy-4 shadow-md">
          ...
          <ul className="sm:flex xs:flex-none sm:mb-8 sm:ml-36 lg:flex lg:my-auto md:my-auto space-x-6 md:space-x-2 text-gray-600 md:flex justify-center sm:space-x-4">
