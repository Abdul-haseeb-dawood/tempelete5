    ...
    <div>
     ...
     <header className="bg-gray-100 mb-10">
        ...
        <nav className="sm:flex-none lg:flex lg:justify-between lg:items-center md:flex md:justify-between md:items-center px-4 lgpy-4 shadow-md">
          ...
          <div className="sm:flex md:flex lg:flex sm:gap-28 xs:flex-none xs:ml-24 ">
         <p className="lg:mt-2 lg:mr-12 md:mr-20 text-blue-500 sm:ml-20 sm:mt-2 xs:ml-20 xs:my-3 font-bold">Login</p>
          <button className="md:text-sm xs:w-52 xs:px-5 xs:py-2.5 md:px-5 md:py-2.5 sm:px-5 sm:py-2.5 sm:mb-3 md:tracking-tighter md:w-44 md:-ml-11 lg:w-44 lg:px-6 lg:py-3 bg-blue-500 text-white lg:text-sm rounded-md">Become a member ➡️ </button>
          </div>
        </nav>
      </header>
